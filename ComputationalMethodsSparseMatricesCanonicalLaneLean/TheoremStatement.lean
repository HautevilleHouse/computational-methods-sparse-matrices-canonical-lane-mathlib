import ComputationalMethodsSparseMatricesCanonicalLaneLean.ReviewerBridge
...
def sourceRepository : String := "computational-methods-sparse-matrices-canonical-lane"
def sourceDescription : String := "Sparse matrix multiplication decision problem"
def sourceTheoremBoundary : String := "Unrestricted sparse matrix multiplication"
def baselineCertificateLane : String := "sparse_constrained"
...
sourceTheoremStatement : TheoremStatement := {
  ...
  manifoldConstrainedStatement := "Sparse-constrained theorem certificate internalized through baseline gates, source constants, reviewer bridge, manifest hashes, and outside-constant dependency count",
...
def ManifoldConstrainedTheoremClosed : Prop :=
  baselineCertificateLane = "sparse_constrained" ∧ baselineCertificateAllPass = true ∧ outsideConstantDependencyCount = 0
